...
# W2 V2a gate deck: planar-z standing sound wave, uniform in r. The gate
# overlays a constant-eta Braginskii run on a control run and compares the
# differential decay rate to gamma = (2/3)(eta/rho) k^2.

Main(
    name="braginskii_wave_2d_planar",
    dimension="2D_RZ",
    t_end=8.0e-5,
    max_steps=200000,
    seed=12345,
...
Output(
    directory="./build/output_verify_braginskii_2d_planar",
    plot_every=0,
    history_every=0,
    checkpoint_every=0,
    plot_every_s=-1.0,
