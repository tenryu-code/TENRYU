...
# MULTI pair: ops/xc/cases/xc0a_z1/ (identical rho/Te/Ti/A/Z, ihydro=0, iradia=0, iheation=0).
...
Output(
    directory="./tmp/xc/xc0a_z1/tenryu",
    plot_every=0,
    history_every=0,
    checkpoint_every=0,
    plot_every_s=0.05 * TAU_EQ,      # 100 snapshots across 5 tau: Te/Ti series
    history_every_s=0.05 * TAU_EQ,
