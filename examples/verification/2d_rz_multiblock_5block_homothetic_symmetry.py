...
N_C = int(os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_N_C", "8"))
FAN_LAYERS = int(
    os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_FAN_LAYERS", "4")
)
NR_SHELL = int(
    os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_NR_SHELL", "8")
)
SEED = int(os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_SEED", "12345"))
S_MAX = float(
    os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_S_MAX_CM", "0.07")
)
T_END = float(
    os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_T_END_S", "5.0e-7")
)
DT_INITIAL = float(
    os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_DT_INITIAL_S", "1.0e-9")
)
DT_MAX = float(
    os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_DT_MAX_S", "5.0e-9")
)
CFL_HYDRO = float(
    os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_CFL_HYDRO", "0.5")
)
MAX_STEPS = int(
    os.environ.get("TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_MAX_STEPS", "20000")
)
OUTDIR = os.environ.get(
    "TENRYU_MULTIBLOCK_5BLOCK_HOMOTHETIC_G3_OUTDIR",
    "./build/output_verify_2d_rz_multiblock_5block_homothetic_g3",
)
...
CASE_NAME = "multiblock_5block_homothetic_symmetry_g3"

print(
    "[deck:2d_rz_multiblock_5block_homothetic_symmetry] "
    f"n_c={N_C} fan_layers={FAN_LAYERS} nr_shell={NR_SHELL} seed={SEED} "
