...
# uniform DT plasma (Z=1, A=2.5, Te=700 eV, Ti=100 eV, n_i=5e21 cm^-3):
# R ~ 0.85 (intermediate; both channels count). t_end = 1e-12 s keeps e-i
# equilibration drift of Te/Ti below 0.2%.

Main(
    name="braginskii_regime_mixed",
    dimension="1D_SPH",
...
Output(
    directory="./build/output_verify_braginskii_regime_mixed",
    plot_every=0,
    history_every=0,
    checkpoint_every=0,
    plot_every_s=-1.0,
