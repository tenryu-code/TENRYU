...
Radiation(
    enabled=True,
    groups=4,
    group_bounds_eV=[0.01, 0.1, 1.0, 10.0, 100.0],
    imc=dict(
    ...
    boundary=dict(inner_r="vacuum", outer_r="marshak", marshak_Tr_eV=100.0, marshak_particles=20000),
)

Laser(enabled=False)

Output(
    directory="./build/output_verify_ddmc_multigroup",
    plot_every=0,
    history_every=0,
    checkpoint_every=0,
    plot_every_s=-1.0,
