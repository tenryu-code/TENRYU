...
Main(
    name="laser_critical_margin_validate",
    dimension="1D_SPH",
    t_end=1.0e-13,
    max_steps=1,
    seed=12345,
...
Laser(
    ...
    wavelength_nm=351.0,
    mode="raytrace_2d",
    raytrace=dict(eps_crit=1.0e-4),
    lasermesh=dict(critical_margin=0.999),
    beams=[
        dict(
            name="b0",
            ...
            f_number=8.0,
            defocus_DR=0.0,
            profile=dict(model="gaussian", w0_um=120.0, m=2),
...
Output(
    directory="./build/output_verify_laser_critical_margin_validate",
    plot_every=0,
    history_every=0,
    checkpoint_every=0,
    plot_every_s=-1.0,
