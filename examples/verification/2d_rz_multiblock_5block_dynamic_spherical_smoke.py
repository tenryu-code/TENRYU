...
OUTDIR = os.environ.get(
    ...
    "./build/output_verify_2d_rz_multiblock_5block_dynamic_spherical_smoke_g4",
)
...
AXIS_REZONE = os.environ.get("TENRYU_G4_5BLOCK_AXIS_REZONE", "0") == "1"
...
CASE_NAME = "multiblock_5block_dynamic_spherical_smoke_g4"

print(
    "[deck:2d_rz_multiblock_5block_dynamic_spherical_smoke] "
    ...
    f"cfl_hydro={CFL_HYDRO} max_steps={MAX_STEPS} axis_rezone={AXIS_REZONE} "
    f"outdir={OUTDIR} "
...
Mesh(
    ...
    nz=NZ,
    grid="uniform",
    motion="ale" if AXIS_REZONE else "lagrangian",
...
Numerics(
    ...
    hydro=dict(
        ...
        av_C1=float(os.environ.get("TENRYU_G4_5BLOCK_AV_C1", "0.1")),
        av_C2=float(os.environ.get("TENRYU_G4_5BLOCK_AV_C2", "1.5")),
