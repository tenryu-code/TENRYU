...
NR = int(os.environ.get("TENRYU_MULTIBLOCK_SEAM_GCL_G1_NR", "8"))
NZ = int(os.environ.get("TENRYU_MULTIBLOCK_SEAM_GCL_G1_NZ", "32"))
...
OUTDIR = os.environ.get(
    ...
    "./build/output_verify_2d_rz_multiblock_seam_gcl_g1",
)
...
CASE_NAME = "multiblock_seam_gcl_g1"

print(
    "[deck:2d_rz_multiblock_seam_gcl_constant_state] "
...
Mesh(
    ...
    multiblock_cart_core_n_c=8,
    multiblock_cart_core_bridge_layers=4,
    multiblock_cart_core_r_c=R_C,
    multiblock_cart_core_r_match=2.0 * R_C,
)
