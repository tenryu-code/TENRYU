...
# NOTE: single-block venue does not reach the M1 rezone (conservative remap runs the
# fixed-grid advection form; rezone-only mode is reference-relaxation). Use
# 2d_rz_multiblock_5block_implosion_characterization.py REZONE_MODE=m1 for the M1 demo.
