...
Main(
    name="hammer_rosen_probe_idealeos",
    dimension="1D_SPH",
    t_end=1.0e-9,
    seed=314159,
    max_steps=500000,
...
Materials(
    materials=[
        Material(
            ...
            A=1.0e5,
            Z=1.0,
            eos=dict(model="ideal_gas", ideal_gas=dict(gamma=5.0/3.0), cv_e_override=8.68e11),
...
Output(
    directory="outputs/hammer_rosen_probe_idealeos",
    plot_every=0,
    history_every=1,
    checkpoint_every=0,
