...
# W2 V2b gate deck: cylindrical standing sound wave (first rigid-wall
# radial acoustic eigenmode u_r ~ J1(k r), kR = j_{1,1}), uniform in z.

Main(
    name="braginskii_wave_2d_cyl",
    dimension="2D_RZ",
    t_end=8.0e-5,
    max_steps=200000,
    seed=12345,
...
Geometry(
    ...
    velocity=lambda r, z: (100.0 * j1_bessel(3.8317059702075123 * r), 0.0),
...
Output(
    directory="./build/output_verify_braginskii_2d_cyl",
    plot_every=0,
    history_every=0,
    checkpoint_every=0,
    plot_every_s=-1.0,
