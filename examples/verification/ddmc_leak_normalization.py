...
Radiation(
    ...
    boundary=dict(inner_r="vacuum", outer_r="marshak", marshak_Tr_eV=100.0, marshak_particles=5000),
)

Laser(enabled=False)

Output(
    directory="./build/output_verify_ddmc_leak_normalization",
    plot_every=0,
    history_every=0,
    checkpoint_every=0,
    plot_every_s=-1.0,
