"""GXII solid CD sphere, 1D_SPH, Gaussian pulse 3600J / FWHM 1.3ns, S_N transport.
...
- S_16 Gauss-Legendre angular quadrature
- Pure-SN Fleck bypass (f=1, σ_s_eff=0)
- Morel-Adams angular redistribution + metric scaling
- DSA acceleration
...
Output(
    directory="outputs/gxii_solid_1D_sn",
    format="hdf5",
