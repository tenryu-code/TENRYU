"""GXII solid CD sphere, 1D_SPH, square pulse 120J / 6ns, FLD radiation transport.
...
Main(
    name="gxii_square_120J_6ns_fld_nr600",
    dimension="1D_SPH",
...
Mesh(
    ...
    grid=dict(
        type="graded",
        segments=[{"r_start": 0.0, "r_end": R_SPHERE, "nr": 600}],
...
Output(
    directory="outputs/gxii_square_120J_6ns_fld_nr600",
    format="hdf5",
