"""GXII solid CD sphere, 1D_SPH, Gaussian pulse, S_N transport, hot-electron preheat.

References: Colaitis 2015 PRE 92.041101; Christopherson 2021 PRL 127.055001;
Ma 2026 PoP 10.1063/5.0297643; Solodov 2022 PRE 106.055204.
...
Laser(
    ...
    # eta_hot is the prescribed conversion fraction at the first source crossing.
    # T_hot_eV is the exponential hot-electron temperature in eV, not keV.
    # The cone model uses theta_div_deg as the deterministic divergence half-angle.
    # QoI: snapshots write hydro/hot_e_eps_cum [erg/g] for kJ/mg-style preheat.
    # Histories write laser/hot_e_* source, deposition, escape, and ledger series.
    hot_electron=dict(
        enable=True,
        eta_hot=0.02,
        T_hot_eV=5.0e4,
