...
Main(
    name="lp1d_ex01_cd_foil_breakout",
    dimension="1D_SPH",
...
# Explicit segments give 400 uniform CD cells and 80 uniform void cells.
# The material interface lies exactly on a cell face at 50 um.
MESH_SEGMENTS = [
    {
        "r_start": 0.0,
...
# Planar 1 cm^2 convention: P[W] = I[W/cm^2] * 1 cm^2; fluence = 9.0e4 J/cm^2.
